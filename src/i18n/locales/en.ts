export const EN_MESSAGES = {
  ...
  uiCopy: {
    ...
    visitorAnalysisPage: {
      ...
      subtitle: (days: number) => `Public traffic summary for the last ${days} days.`,
      loading: 'Loading visitor summary...',
      errorLoading: 'Error loading visitor summary',
      requestFailed: (status: number) => `Visitor summary request failed: ${status}`,
      localCorsHint:
        'If this only fails on localhost, the Worker may still be allowing just the production GitHub Pages origin.',
      windowLabel: 'Time window',
      dayRange: (days: number) => `${days}d`,
      updatedAt: (value: string) => `Updated ${value}`,
      emptyStateTitle: 'No public traffic yet',
      emptyStateDescription: (days: number) =>
        `The public summary endpoint did not return any page views in the last ${days} days.`,
      uniqueVisitorsTitle: 'Unique visitors',
      uniqueVisitorsDetail: (days: number) => `Distinct sessions recorded during the last ${days} days.`,
      pageViewsTitle: 'Page views',
      pageViewsDetail: 'Tracked page-view events collected by the public analytics endpoint.',
      pagesTrackedTitle: 'Tracked pages',
      pagesTrackedDetail: 'Unique page paths that received at least one view in this window.',
      countriesTrackedTitle: 'Countries',
      countriesTrackedDetail: 'Countries represented in the recent visitor summary.',
      topPagesTitle: 'Top pages',
      topPagesDetail: 'Most viewed paths recorded by the tracker for this time window.',
      countriesTitle: 'Countries',
      countriesDetail: 'Recent traffic grouped by country code and ranked by views.',
      viewsLabel: (count: string) => `${count} views`,
      noPages: 'No page views recorded yet.',
      noCountries: 'No countries recorded yet.',
      unknownCountryLabel: 'Unknown region',
      unknownPageLabel: 'Unknown page',
      homePageLabel: 'Home',
    },
    tripDotsPage: {
      eyebrow: 'Travel',
      ...
      viewModeGlobe: 'Globe',
      viewModeFlat: 'Flat',
      tripsPanelTitle: 'Trips',
      tripsPanelDetail: (count: number) => `${count} detected trip${count === 1 ? '' : 's'}`,
      timeRangeLabel: 'Time range',
      legendTripsLabel: 'Trips',
      legendDistanceLabel: 'Distance',
      ...
      showDotsToggle: 'Dots',
      showRoutesToggle: 'Routes',
      funFactsNorthmost: 'Northernmost',
    ...
    nodeEditor: {
      ...
      productionSubtitle:
        'Production workspace · edit content and preview the article locally. Writing project files is disabled here.',
      ...
      fallbackContentReadOnlyNotice: (requestedLanguage: string, resolvedLanguage: string) =>
        `No ${requestedLanguage} content yet — showing ${resolvedLanguage} fallback. Writing is disabled in this production workspace.`,
      tabs: {
        content: 'Edit',
        json: 'JSON',
        newNode: 'New Node',
      ...
      common: {
        ...
        browseNodesHint: 'Browse by domain or search by title, id, subtitle, or domain.',
        ...
        proceed: 'Proceed',
        working: 'Working…',
        leaveBioToCreate: 'Open another node or the main editor view to create a new node or domain.',
      },
      sectionEditor: {
      ...
      status: {
        ...
        wroteBioFile: 'Wrote bio JSON to file.',
        failedWriteNodeFile: 'Failed to write node file.',
        failedWriteBioFile: 'Failed to write bio file.',
      ...
      confirmations: {
        ...
        writeBioChanges: 'write these bio edits to file',
      ...
      domainStats: {
        ...
        timelineTitle: 'Nodes by year',
        timelineDetail: 'How the authored nodes are distributed across years.',
        connectionDistributionTitle: 'Explicit connections per node',
        connectionDistributionDetail: 'How many nodes have 0, 1, 2, 3, 4, or 5+ explicit graph connections.',
        topConnectedNodesTitle: 'Top connected nodes',
        topConnectedNodesDetail: 'The twelve nodes with the highest number of explicit graph connections.',
        strengthDistributionTitle: 'Connection strengths',
        strengthDistributionDetail: 'How explicit graph connections are distributed across strength levels 1-5.',
        treemapTitle: 'Domains treemap',
        treemapDetail: 'How authored nodes are distributed across domains, using area to reflect node count.',
        delete: 'Delete',
      ...
      bioContentTab: {
        emptyState: 'Loading bio content…',
        header: 'Header',
        name: 'Name',
        subtitle: 'Subtitle',
        summary: 'Summary',
        ...
        factHref: 'Fact link (optional)',
        sectionLabel: 'Section label',
        paragraphs: 'Paragraphs',
        paragraphsHint: 'Separate paragraphs with a blank line.',
        emptySection: 'Start writing here.',
        linkLabel: 'Link label',
        linkHref: 'Link href',
        addFact: '+ Add fact',
        addSection: '+ Add section',
        addLink: '+ Add link',
        sidebarHint: 'Edit the bio page fields from this panel. The preview updates live on the right.',
        writeToFile: 'Write to file',
        reset: 'Reset',
      },
      bioJsonTab: {
        emptyState: 'Loading bio JSON…',
        contentJson: 'Bio JSON',
        contentJsonHint: 'Edit the bio page payload directly. The live preview updates whenever the JSON is valid.',
        invalidJson: 'Invalid bio JSON.',
        writeToFile: 'Write to file',
      },
      newNodeTab: {
        domain: 'Domain',
